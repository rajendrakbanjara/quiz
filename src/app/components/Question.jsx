          ...
          <div>
            <div className="space-y-6">
              <ul className="space-y-4">
                <li className="flex items-center font-bold text-white bg-slate-600 p-2 w-[36rem] rounded-2xl text-2xl">
                  <div className="bg-slate-100 text-slate-600 px-5 py-3 ml-2 my-2 rounded-md  mr-7 text-2xl">
                    A
                  </div>
                  4.5:1
                </li>
